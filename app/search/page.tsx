...
export const metadata: Metadata = {
  ...
  description: "Search products by code, name, brand, or category.",
};
  ...
  return (
    <div className="content-page container">
      <div className="content-hero search-hero">
        ...
        <p>
          Find products using code numbers, names, brands, and category keywords.
        </p>
      ...
      {!query ? (
        <section className="section info-card">
          ...
          <p className="muted">
            Enter a product code, product name, brand, or category and we will show the best matches.
          </p>
        </section>
      ) : null}
        ...
        <section className="section">
          ...
          {results.length === 0 ? (
            <div className="info-card">
              ...
              <p className="muted">
                Try a shorter keyword, product code, brand name, or open all products.
              </p>
                ...
                return (
                  <article key={item.id} className="product-card">
                    ...
                    <div className="search-result-actions">
                      <Link href={item.shopPath} className="btn btn-secondary">
                        Open Category
                      </Link>
                    </div>
